...
import com.unittest.block.BlockInput;
import com.unittest.block.BlockOutput;
...
public class Blocks {
	...
	public static final BlockInput UNPOWERED_INPUT_BLOCK;
	public static final BlockInput POWERED_INPUT_BLOCK;
	public static final BlockOutput UNPOWERED_OUTPUT_BLOCK;
	public static final BlockOutput POWERED_OUTPUT_BLOCK;
	...
	static {
		if(!Bootstrap.isRegistered())
			...
			UNPOWERED_INPUT_BLOCK = (BlockInput)getRegisteredBlock("unpowered_input_block");
			POWERED_INPUT_BLOCK = (BlockInput)getRegisteredBlock("powered_input_block");
			UNPOWERED_OUTPUT_BLOCK = (BlockOutput)getRegisteredBlock("unpowered_output_block");
			POWERED_OUTPUT_BLOCK = (BlockOutput)getRegisteredBlock("powered_output_block");
