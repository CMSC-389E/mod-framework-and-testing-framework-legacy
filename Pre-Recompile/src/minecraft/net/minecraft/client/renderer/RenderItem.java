...
public class RenderItem implements IResourceManagerReloadListener {
	...
	private void registerItems() {
		...
		this.registerBlock(Blocks.UNPOWERED_INPUT_BLOCK, "unpowered_input_block");
		this.registerBlock(Blocks.UNPOWERED_OUTPUT_BLOCK, "unpowered_output_block");
	}
	...
	public void renderItem(ItemStack stack, ItemCameraTransforms.TransformType cameraTransformType) {
		if(!stack.isEmpty()) {
			IBakedModel ibakedmodel = getItemModelWithOverrides(stack, (World)null, (EntityLivingBase)null);
	...
	public void renderItemAndEffectIntoGUI(@Nullable EntityLivingBase p_184391_1_, final ItemStack p_184391_2_, int p_184391_3_, int p_184391_4_) {
		if(!p_184391_2_.isEmpty()) {
			...
			try {
				renderItemModelIntoGUI(p_184391_2_, p_184391_3_, p_184391_4_, getItemModelWithOverrides(p_184391_2_, (World)null, p_184391_1_));
