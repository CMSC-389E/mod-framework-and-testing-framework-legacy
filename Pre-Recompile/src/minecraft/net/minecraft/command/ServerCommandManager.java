...
import modblocks.AccountCommand;
import modblocks.CommandAbort;
import modblocks.CommandConfigureWorld;
import modblocks.CommandLoad;
import modblocks.CommandSetInput;
import modblocks.CommandSolution;
import modblocks.CommandSubmit;
import modblocks.CommandTest;
...
public class ServerCommandManager extends CommandHandler implements ICommandListener
{
    ...
    public ServerCommandManager(MinecraftServer serverIn)
    {
        ...
        this.registerCommand(new CommandAbort());
        this.registerCommand(new CommandSetInput());
        this.registerCommand(new CommandConfigureWorld(this));
        this.registerCommand(new CommandSolution(this));
        this.registerCommand(new AccountCommand());
        this.registerCommand(new CommandLoad());
        this.registerCommand(new CommandTest());
        this.registerCommand(new CommandSubmit());
